...
const Booking = () => {
    ...
    return (
        <div className='my-8'>
            ...
            <p className='text-center text-xl px-12 mt-5 mb-12 text-gray-500 text-lg'>Our platform connects you with verified, experienced Lawyers across various specialties — all at your convenience.</p>
